...
const track = document.querySelector('.experiencia-carousel-track');
const prevButton = document.querySelector('.experiencia-carousel-btn.prev');
const nextButton = document.querySelector('.experiencia-carousel-btn.next');
